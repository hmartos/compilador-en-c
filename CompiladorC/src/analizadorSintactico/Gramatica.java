...
/* RDEFINICION2,*/		{{NT.CORCHETES, NT.RDEF_VARIABLE},	{NT.M_AMBITO,parentesisAbierto,NT.L_PARAMS,parentesisCerrado,NT.RDEF_FUNCION}},
...
/* L_SENTENCIAS,*/		{ {llaveAbierta, NT.M_AMBITO,NT.BLOQUE_SENTENCIAS,llaveCerrada}, {NT.M_AMBITO,NT.SENTENCIA} },
/* BLOQUE_SENTENCIAS,*/ { {NT.SENTENCIA,NT.BLOQUE_SENTENCIAS} , {llaveAbierta, NT.M_AMBITO, NT.BLOQUE_SENTENCIAS,llaveCerrada} , {new TokenLambda()} },
...
/* OTRAS_SENTENCIAS,*/	{ {PalRes.PAL_RES_break},{PalRes.PAL_RES_continue},{PalRes.PAL_FUN_printf,parentesisAbierto,NT.EXP,parentesisCerrado},{PalRes.PAL_FUN_scanf,parentesisAbierto, NT.IDENTIFICADOR,parentesisCerrado},{PalRes.PAL_RES_return,NT.EXP} },
...
/* SENTENCIA_CASE,*/	{ {PalRes.PAL_RES_switch,parentesisAbierto,NT.EXP,parentesisCerrado,NT.M_AMBITO,NT.L_CASES} },
...
/*REXPRESIONES*/		{{NT.REXP}, {NT.REXP_COND},{NT.REXP_ORL},{NT.REXP_ANDL},{NT.REXP_ORB},{NT.REXP_XORB},{NT.REXP_ANDB},{NT.REXP_REL},{NT.REXP_COMP},{NT.REXP_DESPL},{NT.REXP_AD},{NT.REXP_MULT},{NT.OP_SELECCION,NT.EXP3},{NT.OP_INC}},
