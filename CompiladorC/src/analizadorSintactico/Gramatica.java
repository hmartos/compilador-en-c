...
/* DEFINICION_GLOBAL,*/	{{NT.MACROS},{NT.DEFINICION_TYPEDEF},{NT.TIPO, NT.RDEFINICION},{NT.DEFINICION_STRUCT}, {NT.DEFINICION_ENUM},{NT.DEFINICION_UNION}},
...
/* DEFINICION_UNION,*/  { {PalRes.PAL_RES_union,new TokenId(null),llaveAbierta, NT.L_VARIABLES,llaveCerrada,NT.INDIRECCION, NT.LISTA_IDENS}} ,
...
/* DEFINICION_STRUCT,*/	{ {PalRes.PAL_RES_struct, new TokenId(null),llaveAbierta, NT.L_VARIABLES,llaveCerrada, NT.INDIRECCION, NT.LISTA_IDENS}},
...
/* SENTENCIA,*/			{ {new TokenPuntoyComa()},{NT.SENTENCIA_IF},{NT.SENTENCIA_BUCLE},{NT.EXP,new TokenPuntoyComa()},{NT.SENTENCIA_CASE},{NT.OTRAS_SENTENCIAS, new TokenPuntoyComa()}, {NT.PROGRAMA}},
...
/* RSENTENCIA_ASIG,*/	{ {NT.EXP}, {parentesisAbierto,NT.LISTA_EXP,parentesisCerrado} },
...
/* CASE,*/				{ {PalRes.PAL_RES_case,NT.EXP,dosPuntos,NT.BLOQUE_SENTENCIAS}, {PalRes.PAL_RES_default,dosPuntos,NT.BLOQUE_SENTENCIAS} },
/* CONSTANTE,*/			{ {NT.EXP_COND} },

/* EXP,*/				{{NT.EXP_COND, NT.REXP}},
/* REXP,*/				{{NT.OP_ASIG, NT.EXP} , {new TokenLambda()}},
/* EXP_COND,*/			{{NT.EXP_ORL, NT.REXP_COND}},
/* REXP_COND,*/			{{new TokenOpTernario(TokenOpTernario.TipoTokenOpTernario.INTERROGACION), NT.EXP,new TokenOpTernario(TokenOpTernario.TipoTokenOpTernario.DOSPUNTOS), NT.EXP},{new TokenLambda()}},
...
/* REXP2,*/				{{NT.OP_INC},{NT.OP_SELECCION, NT.REFERENCIA,NT.INDIRECCION,new TokenId(null), NT.CORCHETES}, {new TokenLambda()}},
...
/* EXP3,*/				{{new TokenNumEntero(0)}, {new TokenNumReal(0)}, {parentesisAbierto, NT.REXP3}, {PalRes.PAL_ESP_NULL},{new TokenComillasChar()}, {new TokenEntrecomillado(null)},{NT.REFERENCIA,NT.INDIRECCION, new TokenId(null), NT.RIDEN}},
/* LISTA_EXP,*/			{{new TokenLambda()}, {NT.EXP, new TokenComa(), NT.LISTA_EXP}},
/*RIDEN*/				{{parentesisAbierto,NT.L_PARAMS_LLAMADA,parentesisCerrado},{NT.CORCHETES},{new TokenLambda()}},
/* REXP3,*/				{{NT.EXP, parentesisCerrado}, {NT.TIPO, parentesisCerrado, NT.EXP}},
